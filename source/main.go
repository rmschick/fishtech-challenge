...
func Handler(request events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	...
	if checkInputForIp(userInput){
		...
		client := ipinfo.NewClient(nil, nil, "6b0a1ab97c8cb3")	//utlize IP information Go Client Library to get IP information https://github.com/ipinfo/go
		...
		if err != nil {	//if there was an error, error out
			panic(err)
		}
